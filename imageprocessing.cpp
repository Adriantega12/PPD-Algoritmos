...
bool ImageProcessing::separateFeet( const cv::Mat& source, cv::Mat& rightFoot, cv::Mat& leftFoot ) {
    ...
    */
    ...
    rightFoot = source( cv::Rect( rlBorder.x - LEFTOVER, ruBorder.y - LEFTOVER,
                                  rrBorder.x - rlBorder.x + LEFTOVER, rbBorder.y - ruBorder.y + LEFTOVER ) );
    leftFoot = source( cv::Rect( llBorder.x - LEFTOVER, luBorder.y - LEFTOVER,
                                             lrBorder.x - llBorder.x + LEFTOVER, lbBorder.y - luBorder.y + LEFTOVER ) );
